...
function Bankdetails() {
  return (
    <div className="bg-[#ECF1F0] text-black m-4 sm:m-8 md:m-12 p-6 sm:p-12 md:p-16 rounded-xl w-full max-w-6xl mx-auto flex flex-col md:flex-row items-start shadow-lg gap-8">
