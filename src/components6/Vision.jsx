...
const Vision = () => {
  return (
    <section className="bg-white text-black py-20 px-6 flex flex-col items-center">
      <div className="max-w-9xl text-center space-y-6">
        ...
        <p className="text-gray-800 text-lg leading-relaxed whitespace-pre-line">
          Transform your home-based business with Nard Homebiz Solution. Our intuitive platform is tailor-made to simplify operations for a variety of industries, from<br/>
