...
const Blog = () => {
  return (
    <section className="relative -mt-28 z-10 px-[80px]" id="blog">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
          ...
          <div className="text-white p-8 flex flex-col justify-between bg-[#263750] shadow-lg w-full h-full">
            <div>
              ...
              <p className="font-normal text-sm sm:text-base">
                Educating, encouraging and <br />training special needs individuals<br />to become self-sufficient, boosting <br />their confidence and independence.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="font-normal text-sm sm:text-base mt-0">
                Upgrading infrastructure in <br />farming to help special needs<br />individuals work better and <br />create inclusive, productive <br />agricultural environments.
              </p>
            </div>
          </div>
          ...
          <div className="bg-green-500 text-white p-10 flex flex-col justify-between shadow-lg w-full h-full">
            <div>
              ...
              <p className="font-normal text-sm sm:text-base">
                Volunteering offers a meaningful <br />opportunity to contribute to <br />community well-being while <br />gaining valuable experience.
              </p>
            </div>
            <a
              href="#"
